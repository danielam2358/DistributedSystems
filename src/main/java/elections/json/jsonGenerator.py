...
states = {'Alabama': 9, 'Kentucky': 8, 'North Dakota': 3, 'Alaska': 3, 'Louisiana': 8, 'Ohio': 18,
          ...
          'Rhode Island': 4, 'Connecticut': 7, 'Minnesota': 10, 'South Carolina': 9, 'Delaware': 3,
          'Mississippi': 6, 'South Dakota': 3, 'District of Columbia': 3, 'Missouri': 10, 'Tennessee': 11,
          'Florida': 29, 'Montana': 3, 'Texas': 38, 'Georgia': 16, 'Nebraska': 5, 'Utah': 6, 'Hawaii': 4,
          'Nevada': 6, 'Vermont': 3, 'Idaho': 4, 'New Hampshire': 4, 'Virginia': 13, 'Illinois': 20,
          'New Jersey': 14, 'Washington': 12, 'Indiana': 11, 'New Mexico': 5, 'West Virginia': 5, 'Iowa': 6,
          'New York': 29, 'Wisconsin': 10, 'Kansas': 6, 'North Carolina': 15, 'Wyoming': 3}
